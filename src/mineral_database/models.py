...
class Mineral:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        optional = [
            'sg', 'ri', 'birefringence', 'optical_character', 'dispersion',
            'lustre', 'cleavage', 'fracture', 'pleochroism', 'twin_law',
            'phenomenon', 'note'
        ]
        for key in optional:
...
INFO_GROUPS = {
    ...
    'full': ['name', 'chemistry', 'system', 'hardness', 'sg', 'ri', 'optical_character', 'cleavage'],
    'fga': ['name', 'ri', 'sg', 'hardness', 'optical_character', 'birefringence', 'cleavage', 'pleochroism'],
}
